...
Transaction fees are taken from users minting and burning. While this is a way to prevent front-running attacks, it also helps to incentivize liquidity providers contributing to Angle Core module.
