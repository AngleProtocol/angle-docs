...
These interest can be claimed with a transaction initiated by clicking on the `Claim Interest` button on the bottom right corner of the above screnshot. Users also have the options to `Claim and Stake`, and `Claim and Mint agEUR`
