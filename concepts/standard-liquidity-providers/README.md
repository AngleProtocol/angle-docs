...
* Standard Liquidity Providers (SLPs) deposit collateral in the core module against sanTokens, yield-bearing tokens that automatically accrue interest and fees.
...
* They may face a small slippage when they exit the core module if it is not enough collateralized.
